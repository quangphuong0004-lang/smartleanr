...
Ứng dụng web học tập trực tuyến tích hợp AI Tutor, chat thời gian thực, quiz kiểm tra và dashboard theo dõi tiến độ.
...
| Role | Mô tả |
|------|-------|
| `student` | Đăng ký khóa học, học bài, làm quiz, chat, hỏi AI |
